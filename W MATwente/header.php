        ...
        <div class="row">
            ...
            <nav class="navbar navbar-default">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="incidentmelden.php">Incident melden</a></li>
                    <li><a href="incidentinzien.php">Incident inzien</a></li>
                    <li><a href="incidentafhandeling.php">Incident afhandeling</a></li>
                    <li><a href="incidentoverzicht.php">Incidenten overzicht</a></li>
